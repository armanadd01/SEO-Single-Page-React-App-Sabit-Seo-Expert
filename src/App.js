            ...
            <Card style={{ width: '90%' }} className='Card-design'>
              ...
              <ListGroup className="list-group-flush">
                <ListGroupItem>
                  ...
                  <a href="https://wa.me/+8801703928204"><FontAwesomeIcon icon={faWhatsapp} /></a>
                </ListGroupItem>
              </ListGroup>
              ...
              <Row>
                ...
                <Col md={6} sm={12} className='d-sm-flex justify-content-center'>
                  <div className="Service-Box-One">
                    <a href="https://www.seoguru.com.bd/" className="text-decoration-none">
                ...
                <Col md={6} sm={12} className='d-sm-flex justify-content-center'>
                  <div className="Service-Box-twos">
                    <a href="https://training.seoguru.com.bd/" className="text-decoration-none">  
                    <div class="serviceBox orange">
                ...
                <Col md={12} sm={12} className='d-sm-flex justify-content-center'>
                  <div className="Service-Box-three">
                    <a  href="https://marketerspanel.com/" className="text-decoration-none">
                      <div class="serviceBox orange">
